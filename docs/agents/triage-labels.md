...
The skills use five canonical triage roles. This file maps those roles to the labels used in this repository.
...
Edit the right-hand column if the repository later adopts different label names.
